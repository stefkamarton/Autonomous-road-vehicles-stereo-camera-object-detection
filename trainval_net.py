...
if __name__ == '__main__':
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            loss_rpn_cls = rpn_loss_cls.data
            loss_rpn_box_left_right = rpn_loss_box_left_right.data
            loss_rcnn_cls = RCNN_loss_cls.data
            loss_rcnn_box = RCNN_loss_bbox.data
            loss_rcnn_dim_orien = RCNN_loss_dim_orien.data
            ...
            if args.use_tfboard:
                info = {
                    ...
                    'loss_rpn_box_left_right': loss_rpn_box_left_right,
                    'loss_rcnn_cls': loss_rcnn_cls,
                    'loss_rcnn_box': loss_rcnn_box,
                    'loss_rcnn_dim_orien': loss_rcnn_dim_orien,
                    'loss_rcbb_kpts': loss_rcnn_kpts
                }
                logger.add_scalars("logs_s_{}/losses".format(epoch), info, (epoch - 1) * iters_per_epoch + step)
